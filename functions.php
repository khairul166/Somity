...
function somity_enqueue_scripts() {
    ...
    // In your somity_enqueue_scripts function
 $currency_symbol = get_somity_currency_symbol();

// Fallback if currency symbol is empty
if (empty($currency_symbol)) {
    ...
    wp_localize_script('somity-dashboard', 'somityAjax', array(
        ...
        'texts' => array(
            'creditApplication' => __('Credit Application', 'somity-manager'),
            'installmentAmountDue' => __('Installment Amount Due', 'somity-manager'),
            'lessCreditBalance' => __('Less: Credit Balance', 'somity-manager'),
            'amountToPay' => __('Amount to Pay', 'somity-manager'),
            'creditAppliedAutomatically' => __('This credit will be automatically applied to your payment.', 'somity-manager'),
            'fullPaymentCoveredByCredit' => __('Your credit balance covers this entire payment. Click "Submit Payment" to apply your credit.', 'somity-manager'),
...
/**
 * Create custom database table for payments
 */
function somity_create_payments_table() {
    global $wpdb;
